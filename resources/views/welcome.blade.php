<x-guest-layout>
  <div class="relative z-10 pt-52 pb-64 bg-cover bg-center" style="background-image: url(/img/bg.jpg)">
      ...
      <div class="container relative z-20 text-white text-center text-2xl">
          <h2 class="font-bold text-5xl mb-5" >Lorem ipsum dolor sit amet consectetur,<br/> adipisicing elit. Odio, explicabo.</h2>
      ...
      <div class="-mt-10">
        <div class="container">
            <div class=" rounded-lg bg-white  p-4 relative z-20 shadow-lg homepage-search-property">
...
<div class="container pt-14">
  <div class="flex justify-between ">
      ...
      <div class="flex-1 ml-10">
          <img class="rounded" src="/img/bg.jpg" alt="">
      </div>
  </div>
</div>
